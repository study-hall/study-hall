...
const tableData = [
  ...
  { Subject: 'Discrete Math for CS II', CourseNumber: 241},
  { Subject: 'Logic Design & Microprocessors', CourseNumber: 331},
  { Subject: 'Algorithms', CourseNumber: 311},
]

/** Renders a table containing all of the Stuff documents. Use <StuffItem> to render each row. */
class ICS extends React.Component {
  state = {
    column: null,
    data: tableData,
    direction: null,
